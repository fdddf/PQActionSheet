...
//    _actionSheet.delegate = self;
    ...
    _actionSheet = [[PQActionSheet alloc]initWithTitle:@"这是一个高仿微信的ActionSheet!" clickedAtIndex:^(NSInteger index) {
        
        NSLog(@"选中了:%ld",index);
        
        
    } cancelButtonTitle:@"取消" otherButtonTitles:@"拍照",@"从手机相册选择",@"保存图片",nil];
